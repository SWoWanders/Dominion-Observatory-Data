    ...
    const factsheet = {
                ...
                list.innerHTML = all.map(fact => `
                    <div class="factsheet-item" draggable="true" data-fact-id="${escapeAttr(fact.id)}">
                        ...
                        <div class="factsheet-item-body">
                            <div class="factsheet-item-context">${escapeHtml(fact.category === 'faqs' ? 'FAQ' : fact.category)} &middot; ${escapeHtml(fact.itemName || '')}</div>
        ...
        print() {
            ...
            all.forEach(fact => {
                ...
                // 'Faqs' looks awkward; use 'FAQ' as the section heading
                if (cat === 'Faqs') cat = 'FAQ';
