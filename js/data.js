...
const ObservatoryData = {
    ...
    buildings: [
        {
            ...
            description: "The main building of the Dominion Observatory was originally intended to stand on Parliament Hill before the site at the north end of the Central Experimental Farm, in Ottawa, was selected in June 1901. Construction began in July 1902, when astronomers Otto Klotz and W.F. King laid out the building's orientation; contractor Théophile Viau began excavating the basement on 12 August 1902, and the building was completed in 1905. Because the structure had originally been destined for the prominent Parliament Hill site, it was personally designed by Chief Dominion Architect David Ewart — who held that office from 1896 to 1914 — rather than being delegated to his staff. Parks Canada's heritage assessment describes it as one of four major federal public buildings raised in Ottawa during the expansionist years of the Wilfrid Laurier government, distinguished by 'a vibrancy not found in other Ottawa federal buildings of this period.' The eclectic design combines references to institutes of higher learning with the contemporary taste for grandiloquent classical buildings with interesting domes.",
            ...
            features: [
                ...
                "Large clock face at the centre of the drum (south façade)",
    ...
    discoveries: [
        ...
        {
            id: "seismic-network-founding",
            title: "Inauguration of Canadian Government Seismic Monitoring",
            description: "In January 1906, Otto Klotz installed a pair of Bosch-Omori photographic seismographs (one east-west, one north-south) in the basement of the Dominion Observatory and began the first systematic Canadian government seismic operation. Within weeks, on 18 April 1906, the new instruments captured the great San Francisco earthquake from over 4,000 km away; Klotz was able to send a seismographic record to the Ottawa newspapers, an early demonstration of the new science to the Canadian public. Following the San Francisco earthquake, Klotz persuaded the Canadian government to join the International Seismological Association in 1907 and represented Canada at international seismological conferences. The Klotz biography in the Dictionary of Canadian Biography records that 'Thanks to Klotz, who was made assistant chief astronomer on 1 April 1911, the Dominion Observatory became one of the most important seismological stations in the world; it issued bulletins on earthquakes and set up seismographs throughout Canada.'",
            by: "Otto Klotz",
            year: 1906,
            month: "January",
            instrument: "Bosch-Omori photographic seismograph (pair, east-west and north-south)",
            firstMajorEvent: "18 April 1906 San Francisco earthquake — captured within weeks of installation",
            significance: "First systematic Canadian government seismic monitoring. The Dominion Observatory became the central station for a national network unified by 1940. The programme continues today as Natural Resources Canada's Canadian Hazards Information Service.",
            seeAlso: "See: Seismology & Earthquake Monitoring (Programs) for the full account",
            citations: ["NRCAN SEISMIC HISTORY", "BIOGRAPHI", "FHBRO 1992", "BROOKS 2005 CASCA"]
        },
        {
            id: "labrador-eclipse-1905",
            title: "1905 Labrador Total Solar Eclipse Expedition",
            description: "From late July through 30 August 1905, the Dominion Observatory mounted Canada's first major government-funded astronomical expedition: a total solar eclipse observation at Cartwright, Labrador. The expedition was led by Director W.F. King, with John Stanley Plaskett as scientific lead and designer of the instrument installation; the equipment included a Brashear coelostat (specifically ordered by King for the expedition and afterwards installed in a dedicated shed at the Observatory for approximately seventy years of solar research), four cameras of 7, 10, 10, and 45-foot focal lengths, and three spectrographs. C.A. Chant, President of the Royal Astronomical Society of Canada, attended and wrote the principal account of the expedition. The eclipse itself was clouded out — heavy cloud cover at Cartwright prevented the scientific observations the expedition had been organised to make — but Plaskett's careful preparation, the published report, and the photographic record of the expedition (held at the Canada Science and Technology Museum as artifact 1974.0754) established the Dominion Observatory's organisational capacity for major scientific field work. The coelostat acquired for this expedition went on to support Ralph DeLury's solar-rotation work in the 1930s and decades of subsequent solar research.",
            year: 1905,
            date: "30 August 1905",
            leader: "W.F. King (commander); J.S. Plaskett (scientific lead)",
            location: "Cartwright, Labrador",
            note: "The expedition was clouded out — no usable eclipse data was obtained — but the institutional precedent it set was significant. The coelostat acquired for this expedition became one of the Observatory's most important long-term instruments.",
            significance: "Canada's first major government-organised astronomical field expedition. Established the Dominion Observatory's capacity for organised scientific field work; acquired the coelostat that supported decades of subsequent solar research in Ottawa.",
            seeAlso: "See: Solar Eclipse Expeditions (Programs) and Solar Research (Programs)",
            citations: ["RASC LABRADOR 1905", "INGENIUM CHANNEL", "ASTRO-CANADA PLASKETT", "BROOKS 2005 CASCA"]
        },
        {
            id: "dao-precursor-role",
            title: "Precursor Work for the Dominion Astrophysical Observatory",
            description: "John Stanley Plaskett's spectroscopic work at the Dominion Observatory in Ottawa (1903-1917) was the institutional and scientific foundation for the Dominion Astrophysical Observatory (DAO) in Saanich, British Columbia. Plaskett designed and built a spectrograph for the Observatory's 15-inch refractor (operational from 1907 onwards); with it he measured radial velocities of thousands of stars and computed orbits of spectroscopic binaries. The published assessment is that the spectrograph 'made the telescope at Ottawa equivalent to much larger instruments,' giving the Ottawa programme a productivity competitive with the Yerkes refractor (then the world's largest). Recognising the limits of a 15-inch refractor for cutting-edge astrophysics, Plaskett proposed in 1910 to Director W.F. King that a much larger Canadian telescope be built. King supported the proposal; Parliament released funds in 1913; and Plaskett worked over the next five years on the design of a 1.83-metre reflector — the largest in the world at the time of its commissioning — for the new Dominion Astrophysical Observatory in Saanich. The DAO opened in 1918, with Plaskett as its first Director. The DAO's foundation case was Plaskett's Ottawa-phase work; the institutional momentum and Plaskett's reputation were both built at the Dominion Observatory.",
            by: "John Stanley Plaskett, with William Edmund Harper",
            period: "1903-1917 (Ottawa phase)",
            note: "The Dominion Astrophysical Observatory in Saanich was a separate institution that opened in 1918 and continues operating today. The Plaskett Telescope at the DAO was the largest in the world for approximately six months before the Hooker 100-inch at Mount Wilson took the title.",
            significance: "Ottawa's spectroscopic work was the proof of concept that secured federal funding for the DAO. Plaskett's reputation, his spectrograph designs, and the radial-velocity programme were all developed at the Dominion Observatory before being transplanted to Victoria.",
            seeAlso: "See: Spectroscopic Astrophysics (Ottawa phase) (Programs)",
            citations: ["JARRELL 1988", "ASTRO-CANADA PLASKETT", "BROOKS 2005 CASCA", "CLARK 1993"]
        }
    ],
    ...
    faqs: [
        {
            ...
            answer: "The Dominion Observatory building is not open to the public for general visits. Since 1970 it has been in continuous federal scientific use; per the Parks Canada heritage designation, the building is occupied by the Geological Survey of Canada (now part of Natural Resources Canada). The Dominion Observatory Campus does, however, participate in the City of Ottawa's annual Doors Open Ottawa event, when members of the public can visit the site. The format varies year to year: past Doors Open weekends have included some building interior access, but in recent and upcoming events public access is more likely to consist of informative tours of the grounds and exterior of the complex rather than entry into the buildings themselves. Check the Doors Open Ottawa website each spring for the current year's specific arrangements.",
            shortAnswer: "Not generally — the building remains in federal scientific use by Natural Resources Canada. Public access is available one weekend each year through the City of Ottawa's annual Doors Open Ottawa event, though that access may be limited to the grounds and exterior of the complex rather than building interiors.",
        ...
        {
            id: "faq-whats-in-the-dome",
            question: "What's inside the dome and tower?",
            answer: "The Dominion Observatory's four-storey octagonal tower is far from empty. It contains several of the building's most significant heritage features — structural, mechanical, and architectural — that together make the tower the architectural and scientific focus of the entire complex, as Parks Canada describes it in the 2025 National Historic Site designation.\n\nThe most prominent feature is the original concrete pier: a monumental column 13 feet (3.96 m) in diameter, sunk deep into the bedrock and rising the full height of the tower. The pier was engineered to isolate the telescope from any vibration in the surrounding building, allowing the 15-inch refractor mounted above to perform with extreme precision. Per the Sharon Odell tour interview, when the building opened in 1905 the pier stood directly in the front entryway, so visitors arriving at the main doors were confronted with this massive structural element and had to walk around it to reach the rest of the building — a deliberate architectural statement that this was, above all else, a serious scientific facility. The pier continues upward through the second, third, and fourth floors of the tower and culminates at the dome floor, where the equatorial mount of the telescope once rested.\n\nThe large clock face at the centre of the drum — visible on the south façade of the tower — is one of the building's most distinctive exterior features. According to Parks Canada, the clock face 'recalls the observatory's former timekeeping function.' The tower clock and its mechanism are heritage features integral to the building's identity as the original source of Canadian official time: from the 1910s onward, the master clock in the base of the building distributed precise time signals via telegraph lines to roughly 700 government clocks across Ottawa, and after 1941 to the entire country.\n\nThe tower is capped by a hemispherical copper-sheathed dome, originally retractable, with shutters that could rotate and open to give the equatorial telescope a clear view of the sky. Parks Canada's 2025 designation describes it as the 'formerly retractable copper dome,' indicating that the rotation mechanism is no longer in active use; the dome and its supporting mechanism are nevertheless intact and remain a defining heritage feature of the building.\n\nThe 15-inch refractor that occupied the dome from 1905 to 1974 is no longer in the building — it was relocated in 1974 to a new educational observatory at the (then) National Museum of Science and Technology, where it continued to host public stargazing until 2014; the telescope itself is now in long-term care at the Ingenium Collections Conservation Centre. The dome's purpose-built equatorial mount remains, however, and the tower retains the architectural and engineering features that made it a national-grade observatory: the pier, the clock face and its mechanism on the south drum, the octagonal masonry tower itself, and the copper dome above. Together, these elements are why the tower is identified by Parks Canada as the architectural and scientific focus of the building and as a defining character-element of the National Historic Site designation.",
            shortAnswer: "The four-storey octagonal tower is the architectural and scientific focus of the building. It contains the original 13-foot (3.96 m) concrete pier that once supported the telescope; the large clock face and tower clock mechanism (Parks Canada notes the clock 'recalls the observatory's former timekeeping function'); and the original copper dome with its equatorial mount — all defining heritage features of the National Historic Site designation. The 15-inch refractor itself was relocated in 1974 and is now at the Ingenium Collections Conservation Centre.",
            citations: ["PARKS CANADA NHSC", "FHBRO 1992", "APT613 ODELL", "INGENIUM CHANNEL", "ASTRO-CANADA DO"]
        },
