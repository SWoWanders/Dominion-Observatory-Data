...
const ObservatoryData = {
    ...
    faqs: [
...

        {
            ...
            question: "What's inside the dome?",
            answer: "Today the dome is empty. The 15-inch refractor that occupied it for 69 years was removed in 1974 when the telescope was relocated to a new dome at the (then) National Museum of Science and Technology. The original Dominion Observatory dome — and the concrete pier on which the telescope once stood — remain in place, but no astronomical instrument is currently mounted there.\n\nThe pier itself is a striking feature of the building's interior: an exposed concrete column 13 feet (3.96 m) in diameter, sunk deep into the bedrock and rising through the centre of the four-storey octagonal tower. When the building opened in 1905, the pier was placed directly in the front entryway, so visitors arriving at the main doors were confronted with this monumental structural piece and had to walk around it to reach the rest of the building — a deliberate architectural statement that this was, above all else, a scientific facility. The pier tapers upward through the second, third, and fourth floors and culminates at the dome, where the equatorial mount of the telescope once sat. A narrow single-file staircase climbs the tower to reach the dome floor.\n\nThe dome itself is a hemispherical copper-sheathed structure built into the top of the octagonal tower. It was originally retractable, with shutters that could rotate and open to give the telescope a clear view of the sky. Parks Canada's 2025 National Historic Site designation, however, describes it as the 'formerly retractable copper dome,' indicating that the rotation and shutter mechanism is no longer functional.\n\nFire-code changes in the 1970s are the reason the dome (and the upper floors of the tower generally) cannot be opened to the public today: the narrow single-file staircase to the dome does not meet modern egress requirements for public buildings, and adding external escape stairs would damage the building's heritage character. This is why public stargazing from the Dominion Observatory ended in 1970 and why the telescope was relocated to a purpose-built educational observatory at the Canada Science and Technology Museum in 1974.",
            shortAnswer: "The dome is empty today. The 15-inch refractor was removed in 1974 (it is now at Ingenium). What remains is the original concrete pier — 13 feet (3.96 m) in diameter — rising through the four-storey octagonal tower, and the formerly retractable copper dome itself, which Parks Canada notes is no longer in working order.",
            citations: ["PARKS CANADA NHSC", "APT613 ODELL", "INGENIUM CHANNEL", "FHBRO 1992"]
        },
