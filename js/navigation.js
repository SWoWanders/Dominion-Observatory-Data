    ...
    renderHome() {
        const hero = `
            <section class="hero-section fade-in">
                <h1 class="hero-title">The Dominion Observatory (Ottawa)</h1>
                <p class="hero-subtitle">
                    Canada's federal astronomical institution (1905\u20131970) and its heritage building complex (1902\u2013present).<br>
                    120 years of Canadian science and architectural heritage \u2022 Federal Heritage Building (1992) \u2022 National Historic Site (announced 2025).
                </p>
                <p class="hero-disambiguation" style="font-size: 0.85em; color: var(--patina); margin-top: 0.5em;">
                    This archive concerns the Dominion Observatory in Ottawa. It is distinct from
                    the Dominion Astrophysical Observatory (DAO) in Saanich/Victoria, BC (1918) and
                    the Dominion Radio Astrophysical Observatory (DRAO) near Penticton, BC (1960).
                </p>
            </section>
        `;
        ...
        const categories = [
            ...
            { id: 'timeline', icon: '📅', name: 'Timeline', count: '40+', desc: 'Chronological history 1852\u20132025' }
        ];
