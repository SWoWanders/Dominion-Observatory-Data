...
const SourceDatabase = {
    ...
    "FHBRO 1992a": {
        ...
        archive: "Carleton University Architecture Museum",
        reliability: "PRIMARY",
        url: "https://www.historicplaces.ca/en/rep-reg/place-lieu.aspx?id=4376",
        accessDate: "2025-02-15"
    },
    ...
    "LAC PA-034064": {
        ...
        urlNote: "LAC has not exposed stable individual-record URLs for many of its photographic holdings. Search 'PA-034064' in the LAC online catalogue.",
        accessDate: "2025-02-15"
    },
    ...
    "HODGSON 1989": {
        ...
        fullCitation: "Hodgson, John H. The Heavens Above and the Earth Beneath: A History of the Dominion Observatories. 2 vols. Ottawa: Energy, Mines and Resources Canada, 1989-1994. Volume 1: 1905-1946; Volume 2: 1946-1970.",
        type: "Academic Monograph (definitive reference work)",
        publisher: "Energy, Mines and Resources Canada",
        reliability: "SECONDARY",
        url: null,
        accessDate: "2025-02-15",
        notes: "The most comprehensive published history of the Dominion Observatory; held in major Canadian research libraries and at LAC. Many of the specific dates and personnel details in this archive ultimately trace to Hodgson."
    },
    ...
    "STEWART 1928": {
        ...
        urlNote: "Verify ADS bibcode; full text of JRASC volumes 1-50 is openly available via NASA ADS",
        accessDate: "2025-02-15",
    ...
    "BEALS 1979": {
        ...
        fullCitation: "Beals, C.S. Personal fonds (papers and crater research files). Library and Archives Canada.",
        type: "Archival Personal Fonds",
        archive: "Library and Archives Canada",
        reliability: "PRIMARY",
        url: "https://www.bac-lac.gc.ca/eng/Pages/home.aspx",
        accessDate: "2025-02-15",
        notes: "Beals died 2 July 1979 in Ottawa. His personal papers — including extensive material on the Dominion Observatory crater research programme — are preserved at LAC. The crater work was published in numerous papers from 1956 onward; see in particular the 1960 Dominion Observatory Publication v. 24 by Millman, Liberty, Clark, Willmore, and Innes on the Brent Crater."
    },
    ...
    "KLOTZ 1922": {
        ...
        fullCitation: "Klotz, Otto. Reports on Canada's accession to the International Astronomical Union and the International Geodetic and Geophysical Union, Rome, 1922.",
        type: "Government Report (verification recommended)",
        reliability: "PRIMARY",
        url: null,
        accessDate: "2025-02-15",
        notes: "Klotz was confirmed as Canada's representative at the inaugural meetings of both the IAU and the IGGU in Rome in 1922 (per the Dictionary of Canadian Biography). The exact title and form of his published report on this trip should be verified against Klotz's bibliography in the JRASC obituary by R.M. Stewart (1924, vol. 18, pp. 1-8) and against his diary in the National Archives of Canada."
    },
    ...
    "CBC 2023": {
        id: "CBC-2023",
        shortForm: "CBC 2023",
        fullCitation: "Canadian Broadcasting Corporation. \"CBC Time Signal Ends After 84 Years.\" News Release, 9 October 2023.",
        type: "News Media",
        publisher: "CBC",
        reliability: "SECONDARY",
        url: "https://www.cbc.ca/",
        urlNote: "Search 'time signal' or 'long dash' on cbc.ca for the announcement",
        accessDate: "2025-02-15"
    },
    ...
    "RASC 1994": {
        id: "RASC-1994",
        shortForm: "RASC 1994",
        fullCitation: "Royal Astronomical Society of Canada. \"William Edmund Harper (1878-1940).\" Journal of the Royal Astronomical Society of Canada, 1994.",
    ...
    "BIOGRAPHI": {
        ...
        urlNote: "King: https://www.biographi.ca/en/bio/king_william_frederick_14E.html | Klotz: https://www.biographi.ca/en/bio/klotz_otto_julius_15E.html",
        accessDate: "2025-02-15",
