...
const SourceDatabase = {
    ...
    "NRCAN SEISMIC HISTORY": {
        id: "NRCAN-SEISMIC-HISTORY",
        shortForm: "NRCan, 'Early History of the Canadian Seismograph Network'",
        fullCitation: "Natural Resources Canada / Earthquakes Canada. \"Early History of the Canadian Seismograph Network.\" Canadian National Seismograph Network (CNSN), accessed 2026.",
        type: "Government heritage page",
        publisher: "Natural Resources Canada / Earthquakes Canada",
        reliability: "PRIMARY",
        url: "https://www.earthquakescanada.nrcan.gc.ca/stndon/CNSN-RNSC/seismog_hist-en.php",
        accessDate: "2026-05-17",
        notes: "Successor agency to the Dominion Observatory's seismology programme. Detailed station-by-station history of Canadian seismographs from 1906 onwards, including the Bosch-Omori, Wiechert, Mainka, Milne-Shaw and successor instruments."
    },

    "SCIENCE.GC.CA GRAVITY 1902": {
        id: "SCIENCE-GC-CA-GRAVITY-1902",
        shortForm: "Government of Canada, 'Gravity Measurement (1902)'",
        fullCitation: "Government of Canada. \"50. Gravity Measurement (1902).\" In '175 Objects: A Brief History of the Geological Survey of Canada'. Accessed 2026.",
        type: "Government heritage page",
        publisher: "Science.gc.ca / Geological Survey of Canada",
        reliability: "PRIMARY",
        url: "https://science.gc.ca/site/science/en/educational-resources/history-geological-survey-canada-175-objects/50-gravity-measurement-1902",
        accessDate: "2026-05-17",
        notes: "Brief authoritative account of Klotz's 1902 first Canadian gravity measurement, the establishment of the 25-station network by 1915, and the institutional continuity from Dominion Observatory to Earth Physics Branch (1970) to Geological Survey of Canada (1986)."
    },

    "SCIENCE.GC.CA OBSERVATORY 1905": {
        id: "SCIENCE-GC-CA-OBSERVATORY-1905",
        shortForm: "Government of Canada, 'First Government Observatory (1905)'",
        fullCitation: "Government of Canada. \"52. First Government Observatory (1905).\" In '175 Objects: A Brief History of the Geological Survey of Canada'. Accessed 2026.",
        type: "Government heritage page",
        publisher: "Science.gc.ca / Geological Survey of Canada",
        reliability: "PRIMARY",
        url: "https://science.gc.ca/site/science/en/educational-resources/history-geological-survey-canada-175-objects/52-first-government-observatory-1905",
        accessDate: "2026-05-17",
        notes: "Authoritative federal account of the Dominion Observatory's founding, mandate, and 1970 closure / transfer of functions to NRC (astronomy) and the Earth Physics Branch (geophysics)."
    },

    "NATURE 1940 SEISMIC": {
        id: "NATURE-1940-SEISMIC",
        shortForm: "Nature, 'Canadian Seismological Stations' (1940)",
        fullCitation: "\"Canadian Seismological Stations.\" Nature 146, 804 (14 December 1940).",
        type: "Scientific journal news item",
        publisher: "Nature",
        reliability: "PRIMARY",
        url: "https://www.nature.com/articles/146804d0",
        accessDate: "2026-05-17",
        notes: "Brief 1940 announcement noting that 'All seismological stations in Canada now come within the jurisdiction of one department, with the Dominion Observatory at Ottawa as the Central Station.' Confirms the 1940 consolidation date for the national seismograph network under the Dominion Observatory."
    },

    "ASTRO-CANADA DO": {
        id: "ASTRO-CANADA-DO",
        shortForm: "Astro-Canada, 'The Dominion Observatory'",
        fullCitation: "Canada under the Stars. \"The Dominion Observatory.\" Observatories section, accessed 2026.",
        type: "Educational web resource",
        publisher: "Astro-Canada / Canada under the Stars",
        reliability: "SECONDARY",
        url: "https://astro-canada.ca/l_observatoire_federal-the_dominion_observatory-eng",
        accessDate: "2026-05-17",
        notes: "Public-facing summary of the Dominion Observatory's mandate, key staff, time-service work (700 Ottawa clocks by 1930; nationwide official time by 1941), and positional astronomy programme (3,162 stars 1911-1923; 1,368 stars 1923-1950)."
    },

    "ASTRO-CANADA PLASKETT": {
        id: "ASTRO-CANADA-PLASKETT",
        shortForm: "Astro-Canada, 'John Stanley Plaskett'",
        fullCitation: "Canada under the Stars. \"John Stanley Plaskett.\" Astronomers section, accessed 2026.",
        type: "Educational web resource",
        publisher: "Astro-Canada / Canada under the Stars",
        reliability: "SECONDARY",
        url: "https://astro-canada.ca/john_stanley_plaskett-eng",
        accessDate: "2026-05-18",
        notes: "Biographical sketch of J.S. Plaskett covering his Ottawa-phase spectroscopic work, the 1905 Labrador eclipse expedition (clouded out), the 1910 proposal for a larger Canadian telescope, the 1913 Parliamentary funding, and the 1918 opening of the Dominion Astrophysical Observatory in Saanich, B.C."
    },
    ...
    "APT613 ODELL": {
        id: "APT613-ODELL",
        shortForm: "Apt613 / Odell interview (2017)",
        fullCitation: "Carroll, Brian. 'A tour inside the historic Dominion Observatory: An interview with Sharon Odell.' Apartment613, 15 May 2017.",
        type: "Interview / community journalism",
        publisher: "Apartment613",
        reliability: "SECONDARY",
        url: "https://apt613.ca/dominion-observatory/",
        accessDate: "2026-05-17",
        notes: "Detailed interview with researcher Sharon Odell describing a 2017 walking tour of the Dominion Observatory's interior — the concrete pier in the front entryway, the narrow single-file staircase to the dome, and the 1970s fire-code changes that ended public access. Useful primary-ish source for what visitors actually see inside the dome and tower."
    },
    ...
    "DOORS OPEN OTTAWA": {
        id: "DOORS-OPEN-OTTAWA",
        shortForm: "Doors Open Ottawa, 'Dominion Observatory Campus'",
        fullCitation: "City of Ottawa. \"Dominion Observatory Campus, Natural Resources Canada (NRCan).\" Doors Open Ottawa 2025.",
        type: "Government event listing",
        publisher: "City of Ottawa",
        reliability: "PRIMARY",
        url: "https://ottawa.ca/en/arts-heritage-and-events/doors-open-ottawa/2025-buildings/dominion-observatory-campus-natural-resources-canada-nrcan",
        accessDate: "2026-05-16",
        notes: "The Dominion Observatory Campus participates in the City of Ottawa's annual Doors Open Ottawa event, allowing some form of public access on the designated weekend. The format varies year to year; past events have offered building interior access, but recent and upcoming events may be limited to informative tours of the grounds and complex exterior. Check the current year's Doors Open Ottawa listing for specifics."
    },

    "INGENIUM CCC": {
        id: "INGENIUM-CCC",
        shortForm: "Ingenium Collections Conservation Centre",
        fullCitation: "Ingenium Museums. \"Collections Conservation Centre.\" Canada Science and Technology Museums Corporation.",
        type: "Museum facility",
        publisher: "Ingenium Museums",
        reliability: "PRIMARY",
        url: "https://ingeniumcanada.org/collection-research/conservation",
        accessDate: "2026-05-16",
        notes: "The Ingenium Collections Conservation Centre opened on the former site of the Helen Sawyer Hogg Observatory after the latter was dismantled in 2016. The Dominion Observatory's 15-inch refractor is now in storage here."
    }
};
